...
export class UpdateEntity1782112957710 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9fb9e8f942e752a7dae3ac8d4c" ON "vocabularies"  ("tag_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tags_type_enum" AS ENUM('VOCAB', 'QUOTE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_5941c379dcf1236f6523a4d14a" ON "quotes"  ("tag_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "user_streaks" ("user_id" uuid NOT NULL, "current_streak" integer NOT NULL DEFAULT '0', "last_active_date" date, "highest_streak" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_91fc9bfd912d8ce3ae4be2ea193" PRIMARY KEY ("user_id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_vocabulary_progress_status_enum" AS ENUM('LEARNING', 'MASTERED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_vocabulary_progress" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "vocabulary_id" uuid NOT NULL, "status" "public"."user_vocabulary_progress_status_enum" NOT NULL DEFAULT 'LEARNING', CONSTRAINT "UQ_USER_VOCABULARY" UNIQUE ("user_id", "vocabulary_id"), CONSTRAINT "PK_1a8ca2862526c9ec009b65e499c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_7cceeefa847caf410e3c79a66a" ON "user_vocabulary_progress"  ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_96188b677e634541bf8545cac9" ON "user_vocabulary_progress"  ("vocabulary_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_activity_active_type_enum" AS ENUM('LOGIN', 'LEARN_FLASHCARD', 'READ_QUOTE')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_activity_target_type_enum" AS ENUM('VOCABULARY', 'QUOTE', 'TAG', 'NONE')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_activity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "active_type" "public"."user_activity_active_type_enum" NOT NULL, "target_type" "public"."user_activity_target_type_enum" NOT NULL DEFAULT 'NONE', "target_id" uuid, CONSTRAINT "PK_daec6d19443689bda7d7785dff5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_11108754ec780c670440e32baa" ON "user_activity"  ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4f6084d8f05f79aac2f72b4ed0" ON "user_activity"  ("target_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "roles" DROP CONSTRAINT "UQ_f6d54f95c31b73fb1bdd8e91d0c"`,
    );
    await queryRunner.query(`ALTER TABLE "roles" DROP COLUMN "code"`);
    await queryRunner.query(
      `ALTER TABLE "roles" ADD "code" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles" ADD CONSTRAINT "UQ_f6d54f95c31b73fb1bdd8e91d0c" UNIQUE ("code")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "vocabularies" ADD CONSTRAINT "FK_9fb9e8f942e752a7dae3ac8d4c7" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "quotes" ADD CONSTRAINT "FK_5941c379dcf1236f6523a4d14a5" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_vocabulary_progress" ADD CONSTRAINT "FK_7cceeefa847caf410e3c79a66af" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_vocabulary_progress" ADD CONSTRAINT "FK_96188b677e634541bf8545cac9e" FOREIGN KEY ("vocabulary_id") REFERENCES "vocabularies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_activity" ADD CONSTRAINT "FK_11108754ec780c670440e32baad" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_vocabulary_progress" DROP CONSTRAINT "FK_96188b677e634541bf8545cac9e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_vocabulary_progress" DROP CONSTRAINT "FK_7cceeefa847caf410e3c79a66af"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_streaks" DROP CONSTRAINT "FK_91fc9bfd912d8ce3ae4be2ea193"`,
    );
    await queryRunner.query(
      `ALTER TABLE "quotes" DROP CONSTRAINT "FK_5941c379dcf1236f6523a4d14a5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "vocabularies" DROP CONSTRAINT "FK_9fb9e8f942e752a7dae3ac8d4c7"`,
    );
    await queryRunner.query(`ALTER TABLE "roles" DROP COLUMN "description"`);
    ...
    await queryRunner.query(`ALTER TABLE "roles" DROP COLUMN "code"`);
    await queryRunner.query(
      `ALTER TABLE "roles" ADD "code" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "roles" ADD CONSTRAINT "UQ_f6d54f95c31b73fb1bdd8e91d0c" UNIQUE ("code")`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4f6084d8f05f79aac2f72b4ed0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_11108754ec780c670440e32baa"`,
    );
    await queryRunner.query(`DROP TABLE "user_activity"`);
    await queryRunner.query(
      `DROP TYPE "public"."user_activity_target_type_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."user_activity_active_type_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_96188b677e634541bf8545cac9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7cceeefa847caf410e3c79a66a"`,
    );
    await queryRunner.query(`DROP TABLE "user_vocabulary_progress"`);
    await queryRunner.query(
      `DROP TYPE "public"."user_vocabulary_progress_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "user_streaks"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5941c379dcf1236f6523a4d14a"`,
    );
    await queryRunner.query(`DROP TABLE "quotes"`);
    await queryRunner.query(`DROP TABLE "tags"`);
    await queryRunner.query(`DROP TYPE "public"."tags_type_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9fb9e8f942e752a7dae3ac8d4c"`,
    );
